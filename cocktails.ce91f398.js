 ...
 * limitations under the License.
 */
function qe(e){return e&&e._delegate?e._delegate:e}var ze=function(){"use strict";function e(t,n,i){r(V)(this,e),this.name=t,this.instanceFactory=n,this.type=i,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}return r(W)(e,[{key:"setInstantiationMode",value:function(e){return this.instantiationMode=e,this}},{key:"setMultipleInstances",value:function(e){return this.multipleInstances=e,this}},{key:"setServiceProps",value:function(e){return this.serviceProps=e,this}},{key:"setInstanceCreatedCallback",value:function(e){return this.onInstanceCreated=e,this}}]),e}(),Je="[DEFAULT]",Ke=function(){"use strict";function e(t,n){r(V)(this,e),this.name=t,this.container=n,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}return r(W)(e,[{key:"get",value:function(e){var t=this.normalizeInstanceIdentifier(e);if(!this.instancesDeferred.has(t)){var r=new Se;if(this.instancesDeferred.set(t,r),this.isInitialized(t)||this.shouldAutoInitialize())try{var n=this.getOrInitializeService({instanceIdentifier:t});n&&r.resolve(n)}catch(e){}}return this.instancesDeferred.get(t).promise}},{key:"getImmediate",value:function(e){var t,r=this.normalizeInstanceIdentifier(null==e?void 0:e.identifier),n=null!==(t=null==e?void 0:e.optional)&&void 0!==t&&t;if(!this.isInitialized(r)&&!this.shouldAutoInitialize()){if(n)return null;throw Error("Service ".concat(this.name," is not available"))}try{return this.getOrInitializeService({instanceIdentifier:r})}catch(e){if(n)return null;throw e}}},{key:"getComponent",value:function(){return this.component}},{key:"setComponent",value:function(e){if(e.name!==this.name)throw Error("Mismatching Component ".concat(e.name," for Provider ").concat(this.name,"."));if(this.component)throw Error("Component for ".concat(this.name," has already been provided"));if(this.component=e,this.shouldAutoInitialize()){if(function(e){return"EAGER"===e.instantiationMode}
/**
 * @license
 ...
 * limitations under the License.
 */
var xt=function(){"use strict";function e(t){r(V)(this,e),this.container=t}return r(W)(e,[{key:"getPlatformInfoString",value:function(){return this.container.getProviders().map((function(e){if(function(e){var t=e.getComponent();return"VERSION"===(null==t?void 0:t.type)}(e)){var t=e.getImmediate();return"".concat(t.library,"/").concat(t.version)}return null})).filter((function(e){return e})).join(" ")}}]),e}();var It,Tt,Ot="@firebase/app",St="0.9.4",Rt=new nt("@firebase/app"),At="[DEFAULT]",Ct=(It={},r(q)(It,Ot,"fire-core"),r(q)(It,"@firebase/app-compat","fire-core-compat"),r(q)(It,"@firebase/analytics","fire-analytics"),r(q)(It,"@firebase/analytics-compat","fire-analytics-compat"),r(q)(It,"@firebase/app-check","fire-app-check"),r(q)(It,"@firebase/app-check-compat","fire-app-check-compat"),r(q)(It,"@firebase/auth","fire-auth"),r(q)(It,"@firebase/auth-compat","fire-auth-compat"),r(q)(It,"@firebase/database","fire-rtdb"),r(q)(It,"@firebase/database-compat","fire-rtdb-compat"),r(q)(It,"@firebase/functions","fire-fn"),r(q)(It,"@firebase/functions-compat","fire-fn-compat"),r(q)(It,"@firebase/installations","fire-iid"),r(q)(It,"@firebase/installations-compat","fire-iid-compat"),r(q)(It,"@firebase/messaging","fire-fcm"),r(q)(It,"@firebase/messaging-compat","fire-fcm-compat"),r(q)(It,"@firebase/performance","fire-perf"),r(q)(It,"@firebase/performance-compat","fire-perf-compat"),r(q)(It,"@firebase/remote-config","fire-rc"),r(q)(It,"@firebase/remote-config-compat","fire-rc-compat"),r(q)(It,"@firebase/storage","fire-gcs"),r(q)(It,"@firebase/storage-compat","fire-gcs-compat"),r(q)(It,"@firebase/firestore","fire-fst"),r(q)(It,"@firebase/firestore-compat","fire-fst-compat"),r(q)(It,"fire-js","fire-js"),r(q)(It,"firebase","fire-js-all"),It),Nt=new Map,Lt=new Map;function Pt(e,t){try{e.container.addComponent(t)}catch(r){Rt.debug("Component ".concat(t.name," failed to register with FirebaseApp ").concat(e.name),r)}}function Dt(e){var t=e.name;if(Lt.has(t))return Rt.debug("There were multiple attempts to register component ".concat(t,".")),!1;Lt.set(t,e);var r=!0,n=!1,i=void 0;try{for(var a,o=Nt.values()[Symbol.iterator]();!(r=(a=o.next()).done);r=!0){Pt(a.value,e)}}catch(e){n=!0,i=e}finally{try{r||null==o.return||o.return()}finally{if(n)throw i}}return!0}function Ut(e,t){var r=e.container.getProvider("heartbeat").getImmediate({optional:!0});return r&&r.triggerHeartbeat(),e.container.getProvider(t)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
var qt="firebase-heartbeat-store",zt=null;function Jt(){return zt||(zt=bt("firebase-heartbeat-database",1,{upgrade:function(e,t){if(0===t)e.createObjectStore(qt)}}).catch((function(e){throw Bt.create("idb-open",{originalErrorMessage:e.message})}))),zt}function Kt(e){return Gt.apply(this,arguments)}function Gt(){return(Gt=r(o)(r(s).mark((function e(t){var n,i;return r(s).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.prev=0,e.next=3,Jt();case 3:return n=e.sent,e.abrupt("return",n.transaction(qt).objectStore(qt).get(Zt(t)));case 7:e.prev=7,e.t0=e.catch(0),e.t0 instanceof Ne?Rt.warn(e.t0.message):(i=Bt.create("idb-get",{originalErrorMessage:null===e.t0||void 0===e.t0?void 0:e.t0.message}),Rt.warn(i.message));case 10:case"end":return e.stop()}}),e,null,[[0,7]])})))).apply(this,arguments)}function Xt(e,t){return Yt.apply(this,arguments)}function Yt(){return(Yt=r(o)(r(s).mark((function e(t,n){var i,a,o,u;return r(s).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.prev=0,e.next=3,Jt();case 3:return i=e.sent,a=i.transaction(qt,"readwrite"),o=a.objectStore(qt),e.next=8,o.put(n,Zt(t));case 8:return e.abrupt("return",a.done);case 11:e.prev=11,e.t0=e.catch(0),e.t0 instanceof Ne?Rt.warn(e.t0.message):(u=Bt.create("idb-set",{originalErrorMessage:null===e.t0||void 0===e.t0?void 0:e.t0.message}),Rt.warn(u.message));case 14:case"end":return e.stop()}}),e,null,[[0,11]])})))).apply(this,arguments)}function Zt(e){return"".concat(e.name,"!").concat(e.options.appId)}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */tr="",Dt(new ze("platform-logger",(function(e){return new xt(e)}),"PRIVATE")),Dt(new ze("heartbeat",(function(e){return new $t(e)}),"PRIVATE")),Wt(Ot,St,tr),Wt(Ot,St,"esm2017"),Wt("fire-js","");
/**
 * @license
 ...
 * limitations under the License.
 */
r(o)(r(s).mark((function e(t,n){return r(s).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",Fr(t,"POST","/v1/accounts:signInWithPassword",Dr(t,n)));case 1:case"end":return e.stop()}}),e)})))).apply(this,arguments)}function qn(e,t){return zn.apply(this,arguments)}function zn(){return(zn=
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var oa=function(){"use strict";function e(t){r(V)(this,e),this.providerId=e.PROVIDER_ID,this.auth=Pn(t)}return r(W)(e,[{key:"verifyPhoneNumber",value:function(e,t){return ia(this.auth,e,qe(t))}}],[{key:"credential",value:function(e,t){return ii._fromVerification(e,t)}},{key:"credentialFromResult",value:function(t){var r=t;return e.credentialFromTaggedObject(r)}},{key:"credentialFromError",value:function(t){return e.credentialFromTaggedObject(t.customData||{})}},{key:"credentialFromTaggedObject",value:function(e){var t=e._tokenResponse;if(!t)return null;var r=t.phoneNumber,n=t.temporaryProof;return r&&n?ii._fromTokenResponse(r,n):null}}]),e}();
/**
 * @license
 * Copyright 2021 Google LLC
 *
